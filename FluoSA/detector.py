...
class Detector():
	...
	def __init__(self):
		...
		self.neuro_mapping=None # the neuron categories and names in a Detector
	...
	def train(self,path_to_annotation,path_to_trainingimages,path_to_detector,iteration_num,inference_size):
		...
		print('Neural structures names in annotation file: '+str(model_parameters_dict['neuro_names']))
	...
	def load(self,path_to_detector,neuro_kinds):

		# neuro_kinds: the catgories of neuros / objects to be analyzed
